...
begin
  ...
  try
    ...
    if VarIsEmpty(mysheet.cells[1,1].value) then
    begin
      //Old Style Sheet
      if ((not VarIsEmpty(mysheet.cells[5,4].value)) and (not VarIsEmpty(mysheet.cells[5,6].value))) then
      begin
        //
        ...
        begin
          ...
          try
            ...
            // Use pickup date supplied by DB
            //mysheetASN.Cells[1,2].value  := formatdatetime('yyyymmdd',StrToDate(mysheet.cells[4,4].value)); //ShipDate
            Data_Module.ProductionDate   := formatdatetime('yyyymmdd',StrToDate(mysheet.cells[4,4].value)); //Store Production Date
            ...
            //mysheetINV.Range['B1','B1'].Value:=formatdatetime('yymmdd',StrToDate(mysheet.cells[4,4].value));  //Invoice Date
            mysheetINV.Range['C1','C1'].Value:='01'+copy(formatdatetime('yy',StrToDate(mysheet.cells[4,4].value)),2,1 ) + formatdatetime('mmdd',StrToDate(mysheet.cells[4,4].value)); //Invoice Number
            ...
            begin
              ...
              begin
                ...
                // Get PO Number and Cost information
                Data_Module.GetExcelPOInfo;

                if not devdatedone then // Add the delivery date to the header the first time this is recovered by partnumber
                begin
                  mysheetASN.Cells[1,2].value  := Data_module.Inv_StoredProc.FieldByName('VC_PICK_UP_DATE').AsString;//formatdatetime('yyyymmdd',StrToDate(mysheet.cells[4,4].value)); //ShipDate
                  mysheetINV.Range['B1','B1'].Value:=copy(Data_module.Inv_StoredProc.FieldByName('VC_PICK_UP_DATE').AsString,3,6)//formatdatetime('yymmdd',StrToDate(mysheet.cells[4,4].value));  //Invoice Date
                end;
                ...
                mysheetASN.Cells[x,2].value  := Data_module.Inv_StoredProc.FieldByName('VC_PO_NUMBER').AsString; //PO Number
                INC(X);
                ...
                mysheetINV.Cells[z,9].value  := Data_module.Inv_StoredProc.FieldByName('VC_PO_NUMBER').AsString; // Reference  USE This to send PO
          ...
          begin
            ...
            begin
              ...
              begin
                //process scrap
                //Data_Module.LogActLog('SCRAP','Partnumber = '+mysheet.cells[i,3].value+mysheet.cells[i,4].value+', Count = '+mysheet.cells[i,5].value);
                //Hist.Append('Scrap Partnumber = '+mysheet.cells[i,3].value+mysheet.cells[i,4].value+', Count = '+mysheet.cells[i,5].value);
              end;
            end;
          end;
          ...
          excelASN.ActiveWorkbook.SaveAs(Data_Module.fiReportsOutputDir.AsString+'\ASN'+formatdatetime('yyyymmddhhmmss00',now)+'.csv',xlCSV);
          ...
          //excelINV.ActiveWorkbook.SaveAs(Data_Module.fiReportsOutputDir.AsString+'\INV'+formatdatetime('yyyymmddhhmmss00',now)+'.xls', file);
          excelINV.ActiveSheet.SaveAs(Data_Module.fiReportsOutputDir.AsString+'\INV'+formatdatetime('yyyymmddhhmmss00',now)+'.csv',xlCSV );
    ...
    begin
      ...
      //
        ...
        begin
          //  No Sequence Numbers on new form
          //
          //Data_Module.StartSeq:=mysheet.cells[5,4].value;
          //Data_Module.LastSeq:=mysheet.cells[5,6].value;
          ...
          Data_Module.LogActLog('ALC PULL','Production Date:'+Data_Module.ProductionDate);
          Hist.Append('Production Date:'+Data_Module.ProductionDate);

          count:=mysheet.cells[17,5].value;
          ...
          try
            ...
            //ASN Header
            mysheetASN.Cells[1,1].value  := 'H'; //Qualifier
            mysheetASN.Cells[1,2].value  := formatdatetime('yyyymmdd',StrToDate(mysheet.cells[3,2].value)); //ShipDate
            Data_Module.ProductionDate   := formatdatetime('yyyymmdd',StrToDate(mysheet.cells[3,2].value)); //ShipDate
            mysheetASN.Cells[1,3].value  := formatdatetime('hhmm',now); // Ship Time, use now unless something else is needed
            mysheetASN.Cells[1,4].value  := 'PT'; //Ship Code
            mysheetASN.Cells[1,5].value  := 'ASM'; //Packaging Code
            mysheetASN.Cells[1,6].value  := ''; //Lading Qty
            ...
            //INVOICE Header
            mysheetINV.Range['B1','C1'].NumberFormat  := '@';
            mysheetINV.Range['B1','B1'].Value:=formatdatetime('yymmdd',StrToDate(mysheet.cells[3,2].value));  //Invoice Date
            mysheetINV.Range['C1','C1'].Value:='01'+copy(formatdatetime('yy',StrToDate(mysheet.cells[3,2].value)),2,1 ) + formatdatetime('mmdd',StrToDate(mysheet.cells[3,2].value)); //Invoice Number
            mysheetINV.Cells[1,1].value  := 'H'; //Qualifier
            z:=2;
            ...
            begin
              //Data_Module.AssyCode:='42600'+mysheet.cells[i,7].value+'00';
              Data_Module.AssyCode:=mysheet.cells[i,1].value;
              Data_Module.Quantity:=mysheet.cells[i,5].value;
              ...
              begin
                ...
                mysheetINV.Cells[z,9].value  := Data_module.Inv_StoredProc.FieldByName('VC_PO_NUMBER').AsString; // Reference  USE This to send PO
                //mysheetINV.Cells[z,9].value  := Data_module.Inv_StoredProc.FieldByName('VC_BLANKET_PO').AsString; // Reference  USE This to send PO
                mysheetINV.Cells[z,10].value  := formatdatetime('yyyymmdd',StrToDate(mysheet.cells[3,2].value)); // Date
                INC(z);
          ...
          for i:=22 to 30 do
          begin
            if not VarIsEmpty(mysheet.cells[i,2].value) then
            begin
