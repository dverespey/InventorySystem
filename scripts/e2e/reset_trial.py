...
(env GATEWAY_USER/GATEWAY_PASS or scripts/e2e/.env) — NEVER hardcode them.

Usage:  python3 scripts/e2e/reset_trial.py [--headed]
...
def main():
    ...
    if msg == "NEED_CREDS":
        print("Set GATEWAY_USER / GATEWAY_PASS in scripts/e2e/.env (gitignored) or env.")
        return 2
