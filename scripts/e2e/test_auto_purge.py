...
Run:  export SA_PASS='Spike_Dev_2026!'  &&  python3 scripts/e2e/test_auto_purge.py
"""
import os
import subprocess
import sys
...
PURGE_CODE = os.path.join(REPO, "docs", "analysis", "production-readiness",
                          "project-library", "auto_purge", "code.py")
