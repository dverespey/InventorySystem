...
Run:  export SA_PASS='Spike_Dev_2026!'  &&  python3 e2e/test_m4_auth.py
"""
import json
import os
import re
...
AUTH_CODE = os.path.join(REPO, "ignition", "project-library", "auth", "code.py")
USER_ADMIN_VIEW = os.path.join(REPO, "ignition", "perspective-views",
                               "Admin", "Users", "Users", "view.json")
SITES_VIEW = os.path.join(REPO, "ignition", "perspective-views",
