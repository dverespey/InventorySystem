...
Run:  export SA_PASS='Spike_Dev_2026!'  &&  python3 e2e/test_hotcall_e2e.py
"""
...
HOTCALL_PY = os.path.join(ROOT, "ignition", "project-library", "hotcall", "code.py")
EDI856_PY = os.path.join(ROOT, "ignition", "project-library", "edi856", "code.py")
