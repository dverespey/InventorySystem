...
# here. `_ignenv` lives in generators/ (a sibling of e2e/ under the repo root).
...
_DB_SHARED_CODE = os.path.join(_REPO_ROOT, "ignition", "project-library", "db_shared", "code.py")
