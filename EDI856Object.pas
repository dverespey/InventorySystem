...
begin
  ...
  try
    ...
    Data_Module.SiteDataset.Parameters.Clear;
    Data_Module.SiteDataset.Parameters.AddParameter.Name := '@LineName';
    Data_Module.SiteDataset.Parameters.ParamValues['@LineName'] := fLineName;
