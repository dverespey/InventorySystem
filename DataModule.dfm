object Data_Module: TData_Module
  ...
  object ALC_Connection: TADOConnection
    ConnectionString = 
      'Provider=SQLOLEDB.1;Password=noway!;Persist Security Info=True;U' +
      'ser ID=Inventory;Initial Catalog=VehicleOrder;Data Source=DVERES' +
      'PE-CD6D24\MSSQL2008'
    LoginPrompt = False
    Mode = cmRead
    Provider = 'SQLOLEDB.1'
  ...
  object SiteTMMDUNSDataSet: TADODataSet
    Connection = ALC_Connection
    CommandText = 'AD_GetSiteTMMDUNS'
    CommandType = cmdStoredProc
    Parameters = <>
    Left = 160
    Top = 300
