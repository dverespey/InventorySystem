...
begin
  ...
  AssyManifest_DataSet.Parameters.Clear;
  AssyManifest_DataSet.Parameters.AddParameter.Name:='@AssyCode';
  AssyManifest_DataSet.Parameters.ParamValues['@AssyCode']:='';
  AssyManifest_DataSet.Parameters.AddParameter.Name:='@ProdDate';
  AssyManifest_DataSet.Parameters.ParamValues['@ProdDate']:='';
  ...
  begin
    index:=AssemblyPartNumber_Combo.Items.IndexOf(ASNItems_DataSet.FieldByName('Assy Part Number').AsString);
    if index > -1 then
    begin
      AssemblyPartNumber_Combo.Items.Delete(index);
    end;
