          ...
          begin
            ...
            begin
              ...
              begin
                ...
                INV_ShippingStoredProc.Parameters.ParamValues['@Qty'] := FieldByName('VEHICLES').AsInteger * Inv_StoredProc.FieldByName('IN_ASSY_QTY').AsInteger;
              ...
              begin
                ...
                else if (Inv_StoredProc.FieldByName('IN_TIRE_RATIO').AsInteger <> 100) and
                                  (Inv_StoredProc.FieldByName('IN_WHEEL_RATIO').AsInteger = 100) then
                begin
                ...
                begin
                  count:=round((FieldByName('VEHICLES').AsInteger  * Inv_StoredProc.FieldByName('IN_ASSY_QTY').AsInteger *
                    Inv_StoredProc.FieldByName('IN_WHEEL_RATIO').AsInteger) / 100);
                end
                else if (Inv_StoredProc.FieldByName('IN_TIRE_RATIO').AsInteger <> 100) and
                                  (Inv_StoredProc.FieldByName('IN_WHEEL_RATIO').AsInteger <> 100) then
                begin
                  count:=round((round((FieldByName('VEHICLES').AsInteger * Inv_StoredProc.FieldByName('IN_ASSY_QTY').AsInteger *
                    Inv_StoredProc.FieldByName('IN_TIRE_RATIO').AsInteger) / 100) *
                    Inv_StoredProc.FieldByName('IN_WHEEL_RATIO').AsInteger) / 100);
                end;
