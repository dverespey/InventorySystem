        ...
        begin
          ...
          begin
            ...
            begin
              ...
              AssignFile(fcf, Data_Module.fiEDIOut.AsString+'\810'+copy(EDI810.PickUpDate,5,4)+Data_Module.EDI810DataSet.FieldByName('LineName').AsString+'.txt');
              Rewrite(fcf);
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          EDI856.LineName := Data_Module.EDI856DataSet.FieldByName('LineName').AsString;
          if EDI856.Execute then
          begin
            if Data_Module.EDI856DataSet.FieldByName('StartSeq').AsString <> '-1' then
            begin
              Data_Module.LogActLog('EDI','Create EDI 856 filename ('+Data_Module.fiEDIOut.AsString+'\856'+EDI856.PickupDate+EDI856.LineName+'.txt)');
              AssignFile(fcf, Data_Module.fiEDIOut.AsString+'\856'+copy(EDI856.PickupDate,5,4)+EDI856.LineName+'.txt');
            end
            else
            begin
              Data_Module.LogActLog('EDI',Data_Module.fiEDIOut.AsString+'\8HC'+copy(EDI856.PickupDate,4,5)+InttoStr(y)+EDI856.LineName+'.txt');
              AssignFile(fcf, Data_Module.fiEDIOut.AsString+'\8HC'+copy(EDI856.PickupDate,4,5)+InttoStr(y)+EDI856.LineName+'.txt');
              INC(y);
            end;
    ...
    begin
      ...
      begin
        try
          ...
          Parameters.ParamValues['@PDate'] := copy(ProductionDateSelectDlg.ProductionDate,1,4)+copy(ProductionDateSelectDlg.ProductionDate,6,2)+copy(ProductionDateSelectDlg.ProductionDate,9,2);
          Parameters.AddParameter.Name := '@Line';
          Parameters.ParamValues['@Line'] := ProductionDateSelectDlg.Line;
          Open;
