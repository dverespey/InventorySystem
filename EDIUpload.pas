    ...
    begin
      repeat
        ...
        begin
          ...
          begin
            //
            //  Check file for correct source for this site
            //
            ...
            begin
              ...
              Hist.Append('Trading Partner Search: Found '+delSL[4]);
              ...
              begin
                ...
                try
                  ...
                  Hist.Append('EDI 824 Failed to open excel for proecessing');
                end;
              end
              ...
              try
                ...
                if EIN <> '' then
                  ...
                  CopyFile.CopyTo:=Data_Module.fiEDIIn.AsString+'\Archive\'+EDIFileNumber+delSL[10]+'.EDI';
                CopyFile.Copynow;
              except
                on e:exception do
                begin
                  Hist.Append('COPY FILE: FAiled to copy file(), '+e.message);
                end;
              end;
            end
            else
            begin
              Hist.Append('IGNORE: File('+sr.Name+') is not a trading partner file for this site('+delSL[4]+')');
            end;
...
procedure TEDIUpload_Form.splitString(delim: char; s: string; ListOfStrings: TStrings);
var temp: string;
    i: integer;
begin
   ListOfStrings.Clear;
